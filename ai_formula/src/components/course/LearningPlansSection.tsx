      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 id="learning-plans-title" className="text-3xl md:text-4xl font-bold mb-4 text-white">
            {isZhTW ? 'Â≠∏Á?Ë®àÂ?' : 'Learning Plans'}
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto">
            {isZhTW 
              ? '?∏Ê??©Â?‰Ω†Á?Â≠∏Á?Ë®àÂ?ÔºåÂ?Ë≤ªÂÖ•?Ä?ñÂ?Á¥öËá≥Â∞àÊ•≠?àÊú¨??
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div className="border border-yellow-500/50 rounded-lg p-4 bg-yellow-500/5">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="font-semibold text-white">
                          {isZhTW ? 'Â∞àÊ•≠?? : 'Pro Plan'}
                        </h4>
                        <Badge className="bg-yellow-500 text-black">
                          {isZhTW ? '?®Ëñ¶' : 'Recommended'}
                        </Badge>
                      </div>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <Badge variant="outline" className="text-green-400 border-green-400">
                          {isZhTW ? `ÁØÄ??{plan.savings}` : `Save ${plan.savings}`}
                        </Badge>
                      </div>
                      <LearningButton 
                        intent="accent"
                      ...
                      >
                        {isZhTW ? '?áÁ??≥Â?Ê•≠Á?' : 'Upgrade to Pro'}
