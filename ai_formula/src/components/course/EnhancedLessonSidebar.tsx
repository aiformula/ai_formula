    ...
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 sticky top-24 h-fit">
      ...
      <div className="p-6 border-b border-gray-700/50">
        <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
          ...
          {isZhTW ? 'Ë™≤Á?Â§ßÁ∂±' : 'Course Outline'}
        </h3>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-400">
                      {sectionCompletedCount}/{section.items.length} {isZhTW ? 'Â∑≤Â??? : 'completed'}
                    </p>
                  </div>
                </div>
      ...
      <div className="p-4 border-t border-gray-700/50">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-sm font-medium text-green-400">
            {progress.percentage}% {isZhTW ? 'ÂÆåÊ?' : 'Complete'}
          </span>
        </div>
        ...
        >
          {progress.percentage >= 100 
            ? (isZhTW ? 'Ë™≤Á?ÂÆåÊ?!' : 'Course Complete!') 
            : (isZhTW ? 'ÁπºÁ?Â≠∏Á?' : 'Continue Learning')
          }
        </Button>
      </div>
    </div>
