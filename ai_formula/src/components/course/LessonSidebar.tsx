              ...
              >
                <div className="flex items-center w-full">
                  ...
                  <span className="ml-2 text-xs text-gray-400 group-hover:text-blue-300">
                    {item.type === 'reading' ? (isZhTW ? '?±Ë?' : 'Reading') : item.type === 'quiz' ? (isZhTW ? 'Ê∏¨È?' : 'Quiz') : ''}
                  </span>
...
const LessonSidebar: React.FC<LessonSidebarProps> = memo(({ 
  ...
  return (
    <>
      {/* Ê°åÈù¢ sidebarÔºömd ‰ª•‰?Ê∞∏È?È°ØÁ§∫Ôºåmobile ?±Ë? */}
      ...
      {/* Drawer for mobileÔºöÁ¥∞Â±èÊ??™Â??ìÈ?ÔºåÂèØ?úÈ? */}
