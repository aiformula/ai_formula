...
const ICON_MAP: Record<string, JSX.Element> = {
  "創新": <Rocket className="h-8 w-8 text-blue-400" />,
  "科技": <Star className="h-8 w-8 text-yellow-400" />,
  "基礎": <Settings className="h-8 w-8 text-gray-400" />,
  "實踐": <Settings className="h-8 w-8 text-gray-400" />,
  "工具": <Package className="h-8 w-8 text-green-400" />,
  "更新": <RotateCcw className="h-8 w-8 text-purple-400" />,
  "效率": <Zap className="h-8 w-8 text-orange-400" />,
  "設置": <Settings className="h-8 w-8 text-cyan-400" />,
  "其他": <Settings className="h-8 w-8 text-pink-400" />
};
