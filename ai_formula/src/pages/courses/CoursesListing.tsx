        ...
        <div className="container mx-auto px-6">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              {language === 'zh-TW' ? 'AI 課程' : 'AI Courses'}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              >
                {language === 'zh-TW' ? '免費學習計劃' : 'Free Learning Plan'}
              </button>
              <button
              ...
              >
                {language === 'zh-TW' ? '專業學習計劃' : 'Pro Learning Plan'}
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-900 py-16">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12">
            {language === 'zh-TW' ? '為什麼選擇我們' : 'Why Choose Us'}
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2">
                {language === 'zh-TW' ? '專業認證' : 'Professional Certification'}
              </h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2">
                {language === 'zh-TW' ? '本地化教學' : 'Localized Teaching'}
              </h3>
              <p className="text-gray-400">
                {language === 'zh-TW' 
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2">
                {language === 'zh-TW' ? '社群支援' : 'Community Support'}
              </h3>
              <p className="text-gray-400">
                {language === 'zh-TW' 
