...
const AIBusinessAutomationLearning: React.FC = () => {
  ...
  const courseData = {
    ...
    completedHours: Math.round((stats.completedUnits / stats.totalUnits) * 55), // 基於進度計算
    totalHours: 55,
        ...
        >
          ...
          <div className="mt-6">
            <div className="space-y-2">
              ...
              {/* Simplified Progress Analysis - only show if actually incomplete */}
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-semibold text-white">5小時 累積</span>
                </div>
