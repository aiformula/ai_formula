...
適用場景：當您需要圍繞一個宏大目標進行多方面工作時，專案功能就顯得尤為寶貴。您可以將所有相關的 ChatGPT 對話都歸集到同一個專案中，確保知識和上下文的連貫性，極大地提升了工作效率和條理性。`,
    ...
    { 
      id: 16, 
      title: "3.6 AI 助手的高級設定與個人化技巧", 
      duration: "24分鐘",
      transcript: `在掌握了 ChatGPT 的基本功能後，了解如何進行個人化設定和高級配置，能讓您的 AI 助手變得更加智能和貼合您的需求。

個人化設定的重要性：每個用戶的工作習慣、專業領域和溝通風格都不同。通過適當的個人化設定，您可以讓 ChatGPT 更好地理解您的需求，提供更精準和相關的回應。

基礎個人化選項：在設定中，您可以調整語言偏好、回應長度偏好、以及專業術語的使用程度。這些設定會影響 AI 回應的風格和詳細程度。

工作流程整合：了解如何將 ChatGPT 整合到您的日常工作流程中，包括與其他工具的配合使用、批次處理任務、以及建立個人化的提示模板庫。

高級技巧分享：學習一些進階用戶常用的技巧，如如何建立對話模板、如何有效地進行多輪對話、以及如何利用上下文記憶功能來維持長期的工作關係。`,
      keyPoints: [
        "掌握個人化設定的各種選項和效果",
        "學會將AI助手整合到工作流程中",
        "了解高級用戶的使用技巧和最佳實踐",
...
這種協作式的提示工程方法，將使您從 AI 的「使用者」轉變為 AI 的「協作夥伴」，共同創造出更優質的結果。`,
    ...
    { 
      id: 22, 
      title: "4.6 高級提示工程實戰：綜合應用與案例分析", 
      duration: "26分鐘",
      transcript: `在學習了各種提示工程技巧後，本單元將通過實際案例來綜合應用這些技術，幫助您真正掌握高級提示工程的精髓。

案例分析方法：我們將分析多個真實的提示工程案例，從簡單的任務到複雜的多步驟項目，展示如何運用不同技巧來解決實際問題。

複合技巧應用：學習如何組合使用多種提示技巧，例如將角色扮演與思維鏈結合，或者在少樣本提示中融入結構化格式要求。

常見錯誤分析：通過分析常見的提示工程錯誤，幫助您避免這些陷阱，提高提示的成功率和效果。

最佳實踐總結：總結高級提示工程的最佳實踐，包括如何測試和迭代提示、如何建立提示庫、以及如何在團隊中分享和標準化提示工程技巧。

實戰練習：提供多個練習機會，讓您親手設計和優化提示，並學會評估提示效果的方法。`,
      keyPoints: [
        "掌握複合提示技巧的綜合應用方法",
        "學會分析和避免常見的提示工程錯誤",
        "了解提示工程的最佳實踐和標準化流程",
...
社區生態：GPT 商店不僅是一個工具平台，更是一個創意社區。您可以從其他創作者的 GPT 中獲得靈感，學習最佳實踐，並與全球的 AI 愛好者交流經驗。`,
    ...
    { 
      id: 28, 
      title: "5.6 構建 AI 工作流程：整合與自動化策略", 
      duration: "25分鐘",
      transcript: `在掌握了個人化 AI 工具後，本單元將教您如何構建完整的 AI 工作流程，實現更高效的自動化和整合。

工作流程設計原則：學習如何分析現有工作流程，識別可以由 AI 改進或自動化的環節，並設計合理的 AI 整合方案。

多工具協作：了解如何讓不同的 AI 工具（ChatGPT、自訂 GPT、API 等）協同工作，形成完整的解決方案鏈條。

自動化策略：探索各種自動化選項，從簡單的模板復用到複雜的多步驟自動化流程，幫助您提升工作效率。

團隊協作模式：學習如何在團隊環境中部署和管理 AI 工具，包括權限管理、知識共享和標準化流程。

成效評估與優化：掌握如何評估 AI 工作流程的效果，並根據實際使用情況進行持續優化和改進。`,
      keyPoints: [
        "設計高效的AI工作流程和整合方案",
        "實現多個AI工具的協同工作",
        "掌握自動化策略和實施方法",
...
開源與閉源生態的競爭與共榮：以 OpenAI 和 Google 為代表的閉源模型，與以 Meta 的 Llama 系列和 Mistral AI 為代表的開源模型之間的競爭將持續加劇。這將共同推動整個 AI 生態系統的創新和繁榮。`,
    ...
    { 
      id: 34, 
      title: "6.6 AI 時代的學習與成長：持續發展策略", 
      duration: "29分鐘",
      transcript: `作為課程的最後一個單元，我們將探討在快速發展的 AI 時代中，如何保持持續學習和成長，確保您能夠始終跟上技術發展的步伐。

終身學習的重要性：在 AI 技術快速迭代的時代，保持學習的習慣和能力比掌握任何特定工具都更重要。了解如何建立持續學習的框架和方法。

跟蹤技術發展：學習如何有效地跟蹤 AI 領域的最新發展，包括關注哪些信息源、如何篩選有價值的信息、以及如何快速掌握新技術。

建立實踐社群：探索如何建立或加入 AI 實踐社群，與同行交流經驗、分享最佳實踐、並共同解決挑戰。

職業發展規劃：討論 AI 時代的職業發展策略，包括如何提升 AI 相關技能、如何在工作中應用 AI 工具、以及如何為未來的職業變化做準備。

課程總結與未來展望：回顧整個課程的核心內容，總結關鍵學習點，並為您未來的 AI 學習和應用之旅提供指導和建議。`,
      keyPoints: [
        "建立AI時代的終身學習框架和方法",
        "掌握跟蹤技術發展和信息篩選的技巧",
        "建立實踐社群和職業發展策略",
  ...
  return (
          <div className="dark min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      <Navigation />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              >
                ...
                <Button
                  onClick={() => {
                    // 檢查是否為章節最後一個單元（5, 10, 16, 22, 28, 34）
                    const isLastUnitOfTheme = [5, 10, 16, 22, 28, 34].includes(currentUnit.id);
                  ...
                  className={
                    ...
                    [5, 10, 16, 22, 28, 34].includes(currentUnit.id)
