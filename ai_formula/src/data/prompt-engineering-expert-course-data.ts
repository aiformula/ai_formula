...
export const promptEngineeringExpertCourseData: CourseData = {
  ...
  faqData: [
    {
      question: '我係AI新手，完全唔識技術，呢個課程會唔會太難？',
      answer: '絕對唔會！呢個課程專為唔同程度嘅學習者設計。我哋會由最基本嘅概念「咩係提示？」開始，用大量生動嘅比喻同實例，循序漸進。無論你係AI新手，定係想深化技能嘅專業人士（例如商業人士、研究人員、內容創作者），都可以喺呢度搵到巨大價值。'
    },
    {
      question: '坊間有咁多免費嘅AI教學，呢個課程有咩優勝之處？',
      answer: '免費資源教你嘅可能係「點樣問一個好問題」，而我哋教你嘅係「點樣設計一個能夠驅動AI解決複雜問題嘅系統」。我哋嘅獨特性在於深度同體系化：你會學到點樣構建提示鏈、RAG系統、甚至係初步嘅AI智能體，呢啲都係專家級嘅應用，係你喺普通教學中難以學到嘅核心秘技。'
    },
    {
      question: '課程總共幾耐？上堂模式係點？',
      answer: '課程包含 10+ 小時嘅超濃縮精華內容，同埋 22+ 個實戰單元。採用線上自學模式，你可以隨時隨地根據自己嘅進度學習，無限次重溫。課程語言為繁體中文。'
    },
    {
      question: '學完呢個課程，我可以期待啲咩成果？',
      answer: '你將會由一個AI嘅「使用者」，徹底轉變為一個AI嘅「駕馭者」。你唔單止能夠大幅提升自己嘅工作效率，仲有能力為你嘅團隊或公司設計同構建基於AI嘅解決方案。簡單嚟講，你將會獲得喺AI時代不可取代嘅核心競爭力。'
    },
    {
