...
## 想像一下：
你有一個神奇朋友可以畫出你用文字描述的任何東西。

👤 **你說：** "畫一隻在陽光花園玩耍的可愛金毛尋回犬小狗"
🤖 **AI畫：** *30秒內創造出驚人圖像*
...
## 如果你不是"技術達人"不用擔心
這個課程是為完全初學者設計。我們逐步解釋所有東西，就好像你從未用過AI一樣。
...
### 例子1：簡單商業相片
❌ **差：** "商業人士"
✅ **好：** "穿海軍藍西裝的專業商人，自信微笑，現代辦公室背景，企業攝影風格"
  ...
  parts: [
    {
      ...
      descriptionCht: '學習AI是什麼以及為什麼它這麼厲害',
      duration: '1-2 hours',
      durationCht: '1-2小時',
      topics: [
        { name: 'What is AI Image Creation?', nameCht: 'AI圖像創作是什麼？' },
        { name: 'Which Tool Should I Use?', nameCht: '我應該用哪個工具？' },
        { name: 'Setting Up Your First Account', nameCht: '設置你的第一個帳戶' }
      ],
      sampleContent: {
        title: 'Sample: Your First AI Image',
        titleCht: '示例：你的第一張AI圖像',
        prompt: 'A cute golden retriever puppy sitting in a sunny garden, cartoon style, cheerful and happy',
        promptCht: '一隻可愛的金毛尋回犬小狗坐在陽光花園，卡通風格，開朗快樂',
        result: 'Creates an adorable cartoon-style puppy image perfect for beginners',
        resultCht: '創造一張完美適合初學者的可愛卡通風格小狗圖像'
      }
    },
    {
      id: 'part2', 
    ...
    },
    {
      ...
      descriptionCht: '學習專業技巧和技術',
      duration: '3-4 hours', 
      durationCht: '3-4小時',
      topics: [
        { name: 'Using ChatGPT for Better Prompts', nameCht: '用ChatGPT寫更好提示' },
        { name: 'Professional Styles & Effects', nameCht: '專業風格和效果' },
        ...
        tips: [
          {
            ...
            exampleCht: '好：「專業頭像，自信微笑，工作室燈光」\n差：「一個非常專業的商業頭像，自信人士帶溫暖真誠微笑在現代攝影工作室配專業燈光設備...」'
          },
          {
            number: 2,
    ...
    },
    {
      ...
      topics: [
        ...
        { name: 'Composition & Angle Keywords', nameCht: '構圖和角度關鍵詞' },
        { name: 'Texture & Material Keywords', nameCht: '質感和材質關鍵詞' },
        { name: 'Mood & Atmosphere Keywords', nameCht: '情緒和氛圍關鍵詞' },
