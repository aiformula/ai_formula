...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerptEn: "In an age where AI technology advances by the day, are you still relying on manual processes? If so, you need to confront a harsh reality: your business isn't just being inefficient; it's being rapidly outpaced. This article explores the critical concept of \"automation\" and why it is a necessity for survival.",
    author: "Kenneth",
    date: "2025年5月28日",
    dateEn: "May 28, 2025",
    readTime: "9分鐘閱讀",
