...
const AboutCht = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "增加競爭能力",
      description: "無論你係個人定係公司，掌握AI就等於掌握未來嘅入場券。"
    }
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold">我哋係邊個？</h2>
          </motion.div>
          <motion.p 
            className="text-gray-400"
            initial={{ opacity: 0 }}
            ...
            viewport={{ once: true }}
          >
            我哋係一班熱愛AI、專注於自動化技術嘅專家。我哋唔單止會教你理論，更重要嘅係分享實戰經驗，
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold">我哋點樣睇AI工具？</h2>
          </motion.div>
          <motion.p 
          ...
          >
            ...
            到自動化流程 (N8N, Zapier) 應有盡有。我哋深信，冇絕對「最好」或者「最壞」嘅工具，
            只有「最適合」你當下需要嘅工具。
          </motion.p>
          <motion.ul 
            className="space-y-4"
          ...
          >
            {[
              ...
              "專注實用：我哋會集中分享能夠真正解決香港人工作痛點嘅工具。",
              "分享真實資訊：我哋會將第一手嘅測試結果同實戰心得，坦白咁分享俾你。"
            ].map((item, index) => (
              <motion.li 
                key={index}
